...
<!--Begin Login Begin-->
<div class="log_bg">
    <form id="msform" role="form" action="<%= request.getContextPath()%>/boss/regist_sub" method="post" enctype="multipart/form-data">
        <!-- progressbar -->
        <ul id="progressbar">
        ...
        <fieldset>
            ...
            <input type="text" value="" class="l_email" name="id" id="txtidnum" placeholder="请输入身份证号" required>
            ...
            <label for="file">上传身份证正面照片</label>
            <input id="file" placeholder="上传身份证正面照片" multiple name="idz" type="file" accept=".jpg,.png,.gif,.icon"/>
            <label for="file1">上传身份证反面照片</label>
            <input id="file1" placeholder="上传身份证反面照片" name="idf" multiple type="file" accept=".jpg,.png,.gif,.icon"/>
            <label for="file2">上传本人近期照片</label>
            <input id="file2" placeholder="上传本人近期照片" name="face" multiple type="file" accept=".jpg,.png,.gif,.icon"/>
