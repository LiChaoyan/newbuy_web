	...
	<div class="m_content">
   		<div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                	<li><a href="Goodsadd.jsp" class="now">发布商品</a></li>
                    <li><a href="Member_Address.html">出售中的商品</a></li>
            ...
            <div class="left_m">
                ...
                <ul>
                	<li><a href="Member_Safe.html">已卖出商品</a></li>
                    <li><a href="Member_Packet.html">评价管理</a></li>
                </ul>
            </div>
            <div class="left_m">
            	<div class="left_m_t t_bg4">物流管理</div>
                <ul>
                	<li><a href="Member_Member.html">发货</a></li>
                    <li><a href="Member_Results.html">物流工具</a></li>
                    <li><a href="Member_Commission.html">物流服务</a></li>
                    <li><a href="Member_Cash.html">寄快递</a></li>
                </ul>
            </div>
            <div class="left_m">
                <div class="left_m_t t_bg2">客户服务</div>
                <ul>
                    <li><a href="Member_User.html">退款管理</a></li>
                    <li><a href="Member_Collect.html" >售后管理</a></li>
                    <li><a href="Member_Msg.html">举报管理</a></li>
                    <li><a href="Member_Links.html">违规管理</a></li>
                </ul>
            </div>
        </div>
		<div class="m_right">
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
      <tr>
       ...
       <tr><td class="label">商品促销价格：</td><td><input name="" type="text"  class="addtext" style=" width:200px; float:left" /> &nbsp;
            <input type="checkbox" name="">可抵用积分</td></tr>
