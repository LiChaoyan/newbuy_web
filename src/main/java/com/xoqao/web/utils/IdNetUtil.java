...
public class IdNetUtil {
    ...
    //配置您申请的KEY
    public static final String APPKEY = "24540213d8a25ea881422bd3a76eca51";

    //1.身份证信息查询
    public static Id getRequest1(String id) {
        String result = null;
        String url = "http://apis.juhe.cn/idcard/index";//请求接口地址
        Map params = new HashMap();//请求参数
        params.put("cardno", id);//身份证号码
        ...
        try {
            ...
            if (object.getIntValue("error_code") == 0) {
                ...
                userid = (Id) JSON.parse(object.getString("result"));
            } else {
