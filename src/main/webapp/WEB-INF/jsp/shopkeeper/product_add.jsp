...
<link href="<%=request.getContextPath()%>/Scripts/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-3"> <span class="select-box">
				...
				<div class="formControls col-xs-3"> <span class="select-box">
				<select name="" class="select">
					<option value="01">二级分类</option>
					<option value="02">二级分类</option>
					<option value="03">二级分类</option>
					<option value="04">二级分类</option>
					<option value="05">二级分类</option>
				</select>
				</span> </div>
				<div class="formControls col-xs-3"> <span class="select-box">
				<select name="" class="select">
					<option value="001">三级分类</option>
					<option value="002">三级分类</option>
					<option value="003">三级分类</option>
					<option value="004">三级分类</option>
					<option value="005">三级分类</option>
				</select>
				</span> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name=""  placeholder="输入长度" value="" class="input-text" style=" width:25%">
				MM
				<input type="text" name="" placeholder="输入宽度" value="" class="input-text" style=" width:25%">
				MM
				<input type="text" name=""  placeholder="输入高度" value="" class="input-text" style=" width:25%">
				MM </div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">产地：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name=""  placeholder="" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name=""  placeholder="" value="" class="input-text" style="width:90%">
				kg</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="" cols="" rows="" class="textarea"  placeholder="请输入产品简介，最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"></textarea>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/Scripts/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="<%=request.getContextPath()%>/Scripts/lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/Scripts/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="<%=request.getContextPath()%>/Scripts/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
    ...
    $(function() {
        ...
        if ( !WebUploader.Uploader.support('flash') && WebUploader.browser.ie ) {
            ...
            // 压根就没有安转。
                ...
                $wrap('<a href="http://www.adobe.com/go/getflashplayer" target="_blank" border="0"><img alt="get flash player" src="http://www.adobe.com/macromedia/style_guide/images/160x41_Get_Flash_Player.jpg" /></a>');
            }
