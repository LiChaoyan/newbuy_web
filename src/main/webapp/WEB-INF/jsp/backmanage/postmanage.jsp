        ...
        <div class="page-content">
            ...
            <div class="page-head">
                ...
                <div class="page-title">
                    <h1>帖子信息 <small>所有的帖子信息</small></h1>
                </div>
                <!-- END PAGE TITLE -->
                <!-- BEGIN PAGE TOOLBAR -->
                                ...
                                <c:forEach items="${postList}" var="post">
                                    <tr class="odd gradeX">
                                       ...
                                       ${post.title}
                                        ...
                                        <td class="center">
                                            <fmt:formatDate value="${post.date}" pattern="yyyy-MM-dd HH:mm:ss"/>
                                        </td>
                                        <td class="center">
                                            ${post.up}
                                        </td>
                                        <td>
                                            <a href="${pageContext.request.contextPath }/postdelete.form?pid=${post.pid}"><span class="label label-sm label-warning">
									删除 </span></a>
                                        </td>
                                    </tr>
                                </c:forEach>
