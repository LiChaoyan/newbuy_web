...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont"></i> <a href="<%=request.getContextPath()%>/system/admin/index" class="maincolor">首页</a>
	...
	<div class="Hui-article"  style="margin-left: 15px;">
		...
		<p class="cl pd-20">
			...
			<table class="table table-border table-bordered table-bg col-md-4" style="width:100%;height:400px;">
				<thead>
				<tr>
